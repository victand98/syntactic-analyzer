...
public class CreateFile {
    public static void main(String[] args) {
        String path = "syntactic" + File.separatorChar + "data" + File.separatorChar;
        ...
        try {
            ...
            Path syn = Paths.get(System.getProperty("user.dir") + File.separatorChar + "syntactic" + File.separatorChar
                    + "sym.java");
            if (Files.exists(syn))
                Files.delete(syn);

            Files.move(Paths.get(System.getProperty("user.dir") + File.separatorChar + "sym.java"), syn);
            syn = Paths.get(System.getProperty("user.dir") + File.separatorChar + "syntactic" + File.separatorChar
                    + "Syntax.java");
            if (Files.exists(syn))
                Files.delete(syn);
